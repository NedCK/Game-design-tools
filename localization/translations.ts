    ...
    settings: {
      ...
      userGuide: {
        ...
        coreFeatures: {
          ...
          conceptBoard: '**Brainstorm with the Concept Board:** Use the new Game Concept Board for visual brainstorming. Add ideas to the \'Inspiration Board\', then drag them and asset tags from the panel above to the \'Refinement Board\'. Connect tags to form gameplay loops or narrative paths, and add descriptions to the final tag in a chain to crystallize your concepts.',
    ...
    settings: {
      ...
      userGuide: {
        ...
        coreFeatures: {
          ...
          conceptBoard: '**使用构思画板进行头脑风暴：** 使用全新的游戏构思画板进行可视化头脑风暴。在“灵感画板”上添加想法，然后将它们和上方资产面板中的资产标签拖到“精炼画板”上。连接不同的标签以构建游戏循环或叙事路径，并为路径的末端标签添加描述，使您的概念具体化。',
